...
if __name__ == "__main__":
    ...
    print(
        "Random number between min=0 and max=1:",
        generate_random_number_between_min_and_max(0, 1),
    )
    print(
        "Random number with mean=0 and std=1:",
        generate_random_number_with_mean_and_std(0, 1),
    )
